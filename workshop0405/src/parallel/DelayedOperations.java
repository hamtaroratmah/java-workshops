...
public interface DelayedOperations {
     ...
     */
    public static Integer fastMult2(Integer value) {
     ...
     * @return l'entier multiplié par 2
     */
    public static Integer slowMult2(Integer value) {
     ...
     * @return l'entier multiplié par 2
     */
    public static Integer ultraSlowMult2(Integer value) {
     ...
     * @return l'entier multiplié par 2
     */
    public static Integer randomlySlowMult2(Integer value) {
     ...
     */
    public static long runAndRecordTime(Runnable process) {
